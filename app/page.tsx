        ...
        <div className="rounded-2xl border border-neutral-800 bg-neutral-900/50 p-4 shadow-sm">
          ...
          <div className="mt-4 rounded-xl border border-neutral-800 bg-neutral-950/40 p-3 text-xs text-neutral-400">
            ...
            <ul className="mt-1 list-disc space-y-1 pl-5">
              <li>La web manda eventos a <span className="text-neutral-200">/api/event</span> (proxy Vercel).</li>
              <li>En Sheets deben existir <span className="text-neutral-200">Eventos_Orden</span> y <span className="text-neutral-200">Ordenes</span>.</li>
